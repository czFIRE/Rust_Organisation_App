...
BEGIN
    ...
    INSERT INTO associated_company
        (company_id, event_id, type, created_at, edited_at)
        VALUES
        (company1_id, event0_id, 'sponsor', '2023-05-03 10:38:20.4', '2023-12-01 14:30:20.1');

    INSERT INTO associated_company
        (company_id, event_id, type, created_at, edited_at)
        VALUES
        (company2_id, event1_id, 'organizer', '2023-05-03 10:38:20.4', '2023-12-01 14:30:20.1');

    INSERT INTO associated_company
        (company_id, event_id, type, created_at, edited_at)
        VALUES
        (company0_id, event1_id, 'sponsor', '2023-05-03 10:38:20.4', '2023-12-01 14:30:20.1');                
END $$;