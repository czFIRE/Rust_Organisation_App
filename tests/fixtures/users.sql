DO $$
DECLARE
    user0_id CONSTANT UUID := '35341253-da20-40b6-96d8-ce069b1ba5d4';
    user1_id CONSTANT UUID := '0465041f-fe64-461f-9f71-71e3b97ca85f';
    user2_id CONSTANT UUID := 'ac9bf689-a713-4b66-a3d0-41faaf0f8d0c';
    user3_id CONSTANT UUID := '51a01dbf-dcd5-43a0-809c-94ed8e61d420';
