...
DECLARE
  ...
  comment2_id UUID := '3cd0919c-d3de-4acf-83db-fa97cebd6a4d';
  comment3_id UUID := '80a1d82b-f82e-46e4-a36e-b13d693767d1';
  comment4_id UUID := '585f777b-243e-406a-a9ad-4c0a96b035b6';	
  comment5_id UUID := '227a4f8b-4b29-412b-a5de-d5bed4fec57c';
...
BEGIN
    ...
    INSERT INTO task
        ...
        accepts_staff, created_at, edited_at)
        VALUES
        (task1_id, event0_id, event_staff0_id, 'Prepare stage for Santa',
        'hohoho', NULL, 'high', true,
        '2023-05-03 10:42:10.4', '2023-05-03 10:42:10.4');
    ...
    INSERT INTO comment
        ...
        created_at, edited_at)
        VALUES
        (comment1_id, NULL, task0_id, user1_id,
        'I will take care of it.',
        '2023-05-03 11:56:10.4', '2023-05-03 11:56:10.4');
    ...
    INSERT INTO comment
        ...
        created_at, edited_at)
        VALUES
        (comment2_id, NULL, task1_id, user0_id,
        'Thanks!',
        '2023-05-03 11:57:10.4', '2023-05-03 11:57:10.4');
    ...
    INSERT INTO comment
        ...
        created_at, edited_at)
        VALUES
        (comment3_id, event1_id, NULL, user0_id,
        'Santa will need a lot of presents.',
        '2023-05-03 11:58:10.4', '2023-05-03 11:58:10.4');
    ...
    INSERT INTO comment
        ...
        created_at, edited_at)
        VALUES
        (comment4_id, event0_id, NULL, user1_id,
        'I have a problem.',
        '2023-05-03 11:59:10.4', '2023-05-03 11:59:10.4');
    ...
    INSERT INTO comment
        ...
        created_at, edited_at)
        VALUES
        (comment5_id, event0_id, NULL, user0_id,
        'Oh nooo!',
        '2023-05-03 12:00:10.4', '2023-05-03 12:00:10.4');
END $$;